...
* Monks must take vows of chastity, silence, or poverty.
...
Through your training, you gain the ability to heal yourself.  As an action, you can regain hit points equal to 1d8 + your monk level per Ki point spent.
...
When you reach 3rd level, your mastery of Ki grants you special combat maneuvers.  These manuevers are triggered by spending Ki points, and are detailed at the end of the class description.

### Aura of Serenity

Starting at XXX level, you radiate serenity and equanimity, and your allies benefit directly from it.  Friendly creatures within 10 feet of you get a bonus on all saving throws equal to your Wisdom bonus, and cannot be frightened.  You must be conscious to grant this bonus.


### Deflect Missiles

Starting at XXX (3rd) level, you can use your reaction to deflect or catch the missile when you are hit by a ranged weapon attack.  When you do so, the damage you take from the attack is reduced by your damage modifier + your Dexterity modifier + your monk level.
...
Starting at XXX level, you can use you action to end one effect on yourself that is causing you to be charmed or frightened.

### Evasion

Starting at XXX (7th) level, your instinctive agility lets you dodge out of the way of certain area effects, such as a blue dragon's lightning breath or a *fireball* spell.  When you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.

### Purity of Body

Starting at XXX level, your mastery of the ki flowing you through you makes you immune to diseease and poison.

\page

### Stillness of Mind

Starting at XXX (7th) level, you can use your action to end one effect on yourself that is causing you to be charmed or frightened.

### Tongue of the Sun and Moon

Starting at XXX (13th) level, your learn to touch the ki of other minds so that you understand all spoken languages.  Moreover, any creature that can understand a language can understand what you say.

### Tranquility

Starting at XXX (11th) level, you can enter a special meditation that surrouns you with an aura of peave.  At the end of a long ret, you gain the effect of a *sanctuary* spell that lasts until the start of your next long rest (the spell can end early as normal).  The saving throw equals 8 + your Wisdom modifier + your proficiency bonus.

### Diamond Soul

Beginning at XXX (14th) level, your mastery of ki grants you proficiency in all saving throws.

Additionally, when you make a saving throw and fail, you can spend 1 ki point to reroll it and take the second result.

### Heal others [needs better name]

At XXX level, you can extend your Ki outward, and heal others.  As an action, you can heal another creature of 1d8 + your monk level per Ki point spent.

### Timeless Body

At XXX (15th) level, your ki sustains you so that you suffer none of the frailty of old age, and you can't be aged magically.  You can still die of old age, however.  In addition, you no longer need food of water.

### Martial Arts Master

At XXX level, you become a master of martial arts, and your skills are legendary.
...
Starting at XXX level, the following martial arts maneuvers are available to you in combat.  Maneuvers require that you spend the indicated number of Ki points, or 0 if there is no cost specified.  The saving throw DC is calculated as follows:
...
*Cost: 1+ Ki point, 7th level*

You can channel an element (fire, water, air, earth) into your strike, doing an additional 1d6 points of damage of the appropriate type.
